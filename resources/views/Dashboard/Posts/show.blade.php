              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="{{ asset('img/profie.jpg') }}" alt="User Image">
                    <span class="username">
                      <a href="#">{{ $post->user->name }}</a>
                      <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                    </span>
                    <span class="description">Posted - {{ $post->updated_at }}</span>
                  </div>
                  <!-- /.user-block -->
                  <div class="row mb-3">
                        <div class="col-md-12">
                            <h3 class="text-center text-black">{{ $post->title }}</h3>
                        </div>
                  </div>
                  <div class="row mb-3">
                    <div class="col">
                      <img class="img-fluid" src="{{ asset('images/' . $post->gambar) }}" alt="Photo">
                    </div>
                  </div>
                  <!-- /.row -->
                  ...
                  <p>
                    <span class="float-right">
                      <a href="#" class="link-black text-sm">
                        <i class="far fa-comments mr-1"></i> Comments ({{ $comments->count() }})
                      </a>
                    </span>
                  </p>
                </div>
